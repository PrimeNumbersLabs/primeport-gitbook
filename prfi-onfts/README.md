...
1. **Buy a PRFI ONFT** — Acquire one from PrimePort or OpenSea
2. **Stake $PRFI** — Deposit $PRFI tokens into your NFT via the staking platform
3. **Level up** — Each level requires a cumulative amount of staked $PRFI and increases your multiplier
4. **Earn rewards** — Your share of the 100,000 PRFI monthly pool is determined by your total multiplier (base + added)
5. **Compound or withdraw** — Claimed rewards are added to your NFT, or can be withdrawn once you reach max level
...
The first 15 NFTs are **handcrafted** by artist [Olatz Diaz](https://olatzdiaz.com/), each representing one of the first 15 prime numbers. These are one-of-a-kind artworks that will never be minted again.
